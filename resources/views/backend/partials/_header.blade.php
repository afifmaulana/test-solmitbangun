                        ...
                        <ul class="dropdown-user">
                            <li>
                                <div class="dw-user-box">
                                    ...
                                    <div class="u-text">
                                        <h4>Steave Jobs</h4>
                                        <p class="text-muted">varun@gmail.com</p>{{--<a href="{{route('artikel.profile')}}" class="btn btn-rounded btn-danger btn-sm">View Profile</a>--}}</div>
                                </div>
                            </li>
                            <li role="separator" class="divider"></li>
                            <li><a href="{{route('artikel.profile')}}"><i class="ti-user"></i> My Profile</a></li>
